...
const EdenMohila = () => {
    return (
        <div>
            <Helmet>
                <title>Eden Mohila College Chapter - Aachol Foundation</title>
                <meta name="title" content="Eden Mohila College Chapter | Aachol Foundation - You Always Matter" />
            ...
            <Navbar />
            {chapter.slice(1, 2).map(data =>
                <div className="container mb-5">
                    <img style={{ borderRadius: '15px' }} src={data.image} alt="Eden Mohila College Chapter of Aachol Foundation" className="img-fluid mt-5" />
