...
const Blog1 = () => {
    ...
    return (
        <div>
            <Navbar />
            <Helmet>
                <title>দীর্ঘ ১৮ মাস পর খুললো দেশের শিক্ষা প্রতিষ্ঠান - Aachol Foundation</title>
                <meta name="title" content="দীর্ঘ ১৮ মাস পর খুললো দেশের শিক্ষা প্রতিষ্ঠান | Aachol Foundation - You Always Matter" />
