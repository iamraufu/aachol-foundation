...
const Blog2 = () => {
    return (
        <div>
            <Navbar />
            <Helmet>
                <title>প্যানিক অ্যাটাকের কারন, উপসর্গ ও করণীয় - Aachol Foundation</title>
                <meta name="title" content="প্যানিক অ্যাটাকের কারন, উপসর্গ ও করণীয় | Aachol Foundation - You Always Matter" />
